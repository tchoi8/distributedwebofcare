...
In class, we will use terminal, git and Dat. Please familiarize yourself with using the terminal. The class is based on a [class](https://github.com/tchoi8/distributedwebofcare/tree/codesocieties) of same title from the Code Societies Summer 2018. Read a [blog posting](https://medium.com/sfpc/distributed-web-of-care-8847a144487b) by TA Ying Quan Tan.  
